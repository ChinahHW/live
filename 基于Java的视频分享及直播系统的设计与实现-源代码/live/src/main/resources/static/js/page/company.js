...
function tableInit(data) {
    ...
    for (var i=0;i<data.length;i++){
        var btn = '<button data-id="'+data[i].companyId+'" class="layui-btn layui-btn-xs data-update vip">修改</button><button data-id="'+data[i].companyId+'" class="layui-btn layui-btn-xs layui-btn-danger data-delete vip">删除</button>';
        html +='<tr>' +
